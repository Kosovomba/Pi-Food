...
export default function Recipe({id, name, image, diets, error}) {
    ...
    return <div className={styles.container}>
        ...
        <img src={image?image:'https://us.123rf.com/450wm/gioiak2/gioiak21708/gioiak2170800312/84667691-signo-de-interrogaci%C3%B3n-rojo-en-un-plato-sobre-fondo-negro-ilustraci%C3%B3n-3d.jpg?ver=6'} alt='imagen'/>
